...
def memorama():
    ...
    x = int(input('Ingresa un valor en x de la primer carta: '))
    if x > 5:
        print('ERROR')
        memorama()

    y = int(input('Ingresa un valor en y de la primer carta:: '))
    if y > 5:
        print('ERROR')
        memorama()
    ...
    x2 = int(input('Ingresa un valor x de la segunda carta: '))
    if x2 > 5:
        print('ERROR')
        matrix[x][y] = '-'
        memorama()
    else:
        y2 = int(input('Ingresa un valor en y de la segunda carta: '))
        if y2 > 5:
            print('ERROR')
            matrix[x][y] = '-'
            memorama()
...
def condiciones(x,y,x2,y2):
    ...
    if matrix[x][y] != matrix[x2][y2]:
        matrix[x2][y2] = "-"
        matrix[x][y] = "-"
        respuesta = str(input('¿Quieres seguir jugando? si/no: '))
        if respuesta == 'si':
            memorama2()
        elif respuesta == 'no':
